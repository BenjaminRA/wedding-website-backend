...
export interface ApiDressCodeDressCode extends Struct.SingleTypeSchema {
  collectionName: 'dress_codes';
  info: {
    description: 'Dress code information';
    displayName: 'Dress Code';
    pluralName: 'dress-codes';
    singularName: 'dress-code';
  };
  options: {
...
export interface ApiGalleryGallery extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Photo gallery and story';
    displayName: 'Gallery';
...
export interface ApiGiftGift extends Struct.SingleTypeSchema {
  collectionName: 'gifts';
  info: {
    description: 'Gift registry information';
    displayName: 'Gift';
    pluralName: 'gifts';
    singularName: 'gift';
  };
  ...
  attributes: {
    chile: Schema.Attribute.Component<'gift.us-list-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    us: Schema.Attribute.Component<'gift.us-list-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPasswordPassword extends Struct.SingleTypeSchema {
...
export interface ApiScheduleSchedule extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    events: Schema.Attribute.Component<'schedule.event', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiWelcomeWelcome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weddingDate: Schema.Attribute.DateTime &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
